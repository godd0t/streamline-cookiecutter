...
make all            	Show help
make template       	Generate project from template
...
.PHONY: help lint format test super-user make-migrations migrate build-dev build-prod stop-dev stop-prod all template
